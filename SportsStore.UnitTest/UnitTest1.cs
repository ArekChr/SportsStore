...
namespace SportsStore.UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        {
            //definiowanie metody pomocniczej HTML
            ...
            // przygotowanie - konfigutowanie delegatu z uzyciem wyrazenia lambda
            ...
            Assert.AreEqual(
                @"<a class=""btn btn-default"" href=""Strona1"">1</a><a class="" btn btn-default btn-primary selected"" href=""Strona2"">2</a><a class=""btn btn-default"" href=""Strona3"">3</a>> ",
                result.ToString());
        }
